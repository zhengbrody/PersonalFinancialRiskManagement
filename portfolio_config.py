...
PORTFOLIO_HOLDINGS: Dict[str, Dict[str, Any]] = {
    ...
    "MSFT": {"shares": 11, "avg_cost": 397, "account": "margin", "asset_type": "equity"},
    ...
    "AA": {"shares": 8.01, "avg_cost": 59.88, "account": "margin", "asset_type": "equity"},
    "QQQ": {"shares": 2.39, "avg_cost": 561.43, "account": "margin", "asset_type": "etf"},
    "SPY": {"shares": 2.13, "avg_cost": 624.08, "account": "margin", "asset_type": "etf"},
    "GLD": {"shares": 2.6, "avg_cost": 345.52, "account": "margin", "asset_type": "etf"},
