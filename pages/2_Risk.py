...
# ══════════════════════════════════════════════════════════════
render_section("AI Risk Analysis")
try:
...
if st.button("Compute Barra Attribution", key="compute_barra"):
...
# ── Correlation Heatmap ──────────────────────────────────────
with render_section("Correlation Heatmap", collapsed=True):
...
# ── Macro Sensitivity ────────────────────────────────────────
with render_section("Macro Sensitivity", collapsed=True):
...
# ── Rolling Correlation ──────────────────────────────────────
with render_section("Rolling Correlation", collapsed=True):
...
# ── Liquidity Risk ───────────────────────────────────────────
with render_section("Liquidity Risk", collapsed=True):
...
with render_section("Full Factor Beta Heatmap", collapsed=True):
    if fb is not None and not fb.empty:
        fig_fb = px.imshow(
            fb.astype(float),
            text_auto=".2f",
